...
public class Pollo {
    ...
    public Pollo(World w,int posx,int posy){
        ...
        propiedadesFisicasCuerpo.filter.categoryBits=0x0001; //El grupo al que pertenezco
        propiedadesFisicasCuerpo.filter.maskBits=0x0002; //Con qué colisiono , solo colisiono si los bits son iguales a los míos.
